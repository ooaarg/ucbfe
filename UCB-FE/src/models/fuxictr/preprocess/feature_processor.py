...
class FeatureProcessor(object):
    ...
    def preprocess(self, ddf):
        ...
        # active_cols = [col["name"] for col in all_cols if col.get("active")] #  IT MIGHT CRASH EVERYTHING!!!
            ...
            if feature in ddf.columns:
                ...
                if feature_type == "meta":
                    if feature + "::tokenizer" in self.processor_dict:
                        ...
                        ddf[feature] = col_series #tokenizer.encode_meta(col_series) ## MIGHT CRASH EVERYTHIMG
